        ...
        for student_name, student_image_paths in student_images.items():
            for image_path in student_image_paths:
                ...
                '''   
                    ...
                    text_w = text_size[0]
                    text_h = text_size[1]
                    cv2.rectangle(frame, (text_x, text_y), (text_x + text_w, text_y + text_h), (0, 0, 255), cv2.FILLED)
                ...
                if matched:
                    ...
                    cv2.putText(frame, text, (text_x, text_y + text_h), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 255, 255), 2)
        
                    '''
                '''
                # If no student is matched, mark the face as unknown
                if not matched:
                     # Draw a red rectangle around the face
                    color = (0, 0, 255)
                    cv2.rectangle(frame, (x, y), (x+w, y+h), color, 2)
